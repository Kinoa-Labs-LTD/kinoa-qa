...
## Conflicts
- ⚠️ CONFLICT: AC-2 · story: a correct password while LOCKED is refused with 423 and the account stays locked vs openspec: Admin sign-in lockout/A correct password clears the lock says a correct password while LOCKED clears the lock and grants the session — no case was generated for AC-2; the plugin picks no winner
